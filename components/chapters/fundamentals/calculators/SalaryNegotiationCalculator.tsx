            ...
            <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center">
                    <input
                        ...
                        className="mr-3 h-4 w-4 text-green-400 focus:ring-green-500 ${theme.borderColors.primary} rounded"
                    />
                ...
                <button
                    ...
                    className="w-full ${theme.status.success.bg}0 text-white py-3 px-4 rounded-md hover:bg-green-600 transition-colors font-semibold"
                >
                ...
                <div className="${theme.backgrounds.glass} border ${theme.borderColors.primary} rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div className="${theme.backgrounds.glass} border ${theme.borderColors.primary} rounded-lg p-4">
                            ...
                            <p className="${theme.typography.heading2} text-green-400">
                        ...
                        <div className="${theme.backgrounds.glass} border ${theme.borderColors.primary} rounded-lg p-4">
                            ...
                            <p className="${theme.typography.heading2} text-blue-400">
