...
export default function BudgetBuilderCalculator() {
  ...
  const [categories, setCategories] = useState<BudgetCategory[]>([
    // Needs (50%)
    { id: 'housing', name: 'Housing', budgeted: 1500, actual: 1500, color: '#EF4444', type: 'need', icon: '🏠' },
    { id: 'food', name: 'Groceries', budgeted: 400, actual: 450, color: '#F97316', type: 'need', icon: '🛒' },
    { id: 'utilities', name: 'Utilities', budgeted: 200, actual: 180, color: '#EAB308', type: 'need', icon: '💡' },
    { id: 'transportation', name: 'Transportation', budgeted: 300, actual: 320, color: '#DC2626', type: 'need', icon: '🚗' },
    { id: 'insurance', name: 'Insurance', budgeted: 200, actual: 200, color: '#B91C1C', type: 'need', icon: '🛡️' },
    
    // Wants (30%)
    { id: 'entertainment', name: 'Entertainment', budgeted: 300, actual: 350, color: '#8B5CF6', type: 'want', icon: '🎬' },
    { id: 'dining_out', name: 'Dining Out', budgeted: 250, actual: 280, color: '#A855F7', type: 'want', icon: '🍕' },
    { id: 'shopping', name: 'Shopping', budgeted: 200, actual: 180, color: '#C084FC', type: 'want', icon: '🛍️' },
    { id: 'hobbies', name: 'Hobbies', budgeted: 150, actual: 120, color: '#DDD6FE', type: 'want', icon: '🎨' },
    
    // Savings (20%)
    { id: 'emergency', name: 'Emergency Fund', budgeted: 500, actual: 500, color: '#10B981', type: 'savings', icon: '🚨' },
    { id: 'retirement', name: 'Retirement', budgeted: 400, actual: 400, color: '#059669', type: 'savings', icon: '🏖️' },
    { id: 'investments', name: 'Investments', budgeted: 300, actual: 250, color: '#047857', type: 'savings', icon: '📈' },
    { id: 'goals', name: 'Financial Goals', budgeted: 200, actual: 180, color: '#065F46', type: 'savings', icon: '🎯' },
  ]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className={`rounded-lg p-4 ${summary.remaining >= 0 ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
            <h4 className={`font-semibold mb-2 ${summary.remaining >= 0 ? 'text-green-900' : 'text-red-900'}`}>
              {summary.remaining >= 0 ? '💰 Remaining Budget' : '⚠️ Over Budget'}
            </h4>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <h4 className="font-semibold text-blue-900 mb-3">💡 Budgeting Tips</h4>
