    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-6 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-lg p-6">
          <h2 className="text-xl font-bold text-indigo-900 mb-2">📊 Your Financial Education Journey</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="bg-white bg-opacity-50 rounded-lg p-3">
              <h3 className="font-semibold text-indigo-900">🎯 Goal-Oriented Learning</h3>
              <p className="text-indigo-700">Clear progression through mastery-based chapters</p>
            </div>
            <div className="bg-white bg-opacity-50 rounded-lg p-3">
              <h3 className="font-semibold text-indigo-900">📈 Measurable Impact</h3>
              <p className="text-indigo-700">Real data showing your knowledge growth over time</p>
            </div>
            <div className="bg-white bg-opacity-50 rounded-lg p-3">
              <h3 className="font-semibold text-indigo-900">🏆 Achievement System</h3>
        ...
        <div className="mt-8 bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-lg p-6">
          <h3 className="text-lg font-bold text-blue-900 mb-4">🎪 Demo Highlights for Judges</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="font-semibold text-blue-800 mb-3">✅ Technical Excellence</h4>
            ...
            <div>
              <h4 className="font-semibold text-blue-800 mb-3">🎯 Educational Impact</h4>
              <ul className="text-blue-700 space-y-2 text-sm">
