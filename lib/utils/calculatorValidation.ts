...
export const CalculatorValidations = {
    ...
    rewardsOptimizer: {
        ...
        groceries: ValidationPresets.currency(0, 5000),
        gasoline: ValidationPresets.currency(0, 2000),
        dining: ValidationPresets.currency(0, 3000),
        travel: ValidationPresets.currency(0, 10000),
        entertainment: ValidationPresets.currency(0, 2000),
        shopping: ValidationPresets.currency(0, 5000),
        utilities: ValidationPresets.currency(0, 1000),
        other: ValidationPresets.currency(0, 5000),

        // Settings
        timeHorizon: ValidationPresets.positiveInteger(1, 60),
        includeAnnualFees: { required: false },
        includeSignupBonus: { required: false }
    }
};
